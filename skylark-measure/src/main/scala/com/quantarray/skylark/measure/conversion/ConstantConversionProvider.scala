...
/**
 * Constant conversion provider.
 *
 * @author Araik Grigoryan
 */
trait ConstantConversionProvider
{
  /**
   ...
   */
  def factor(numerator: Measure, denominator: Measure): Option[Double]

  /**
   * Gets a function that converts from source to target measure.
   */
  def fun(source: Measure, target: Measure)(d: Double): Option[Double]
}