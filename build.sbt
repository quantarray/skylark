...
lazy val `skylark-timeseries-cassandra` = project.dependsOn(`skylark-time`, `skylark-timeseries`)
...
lazy val skylark = project.in(file(".")).aggregate(`skylark-natural-language`, `skylark-timeseries`, `skylark-timeseries-cassandra`, `skylark-measure`, `skylark-measure-market`, `skylark-learning`, `skylark-learning-neural`)
